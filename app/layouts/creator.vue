<template>
  ...
  >
    <header
      id="header"
      class="bg-primary-900/75 border-b border-primary-800/75"
    >
    ...
    <aside
      id="aside"
      class="bg-primary-900/50 p-4 border-r border-primary-800/50 space-y-6"
    >
      <div>
        <h1 class="text--gradient font-semibold text-2xl">
          Quizzio
        </h1>
      </div>
      <div class="relative">
    ...
    <div
      id="content"
      class="bg-primary-950 p-8 relative"
    >
      <NuxtImg
